...
//
// parts of this script got written by unregi Resident. 
// modifications into version 2 by hflocki
// ****************************************************************
// ****************************************************************
//
//
...
default
{
    ...
    {
		if (msg == gsSwitchDoor){ TriggerTheDoor();}
